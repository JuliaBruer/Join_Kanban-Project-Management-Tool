...
/**
 * This function sends an email using the provided form data and redirect to a confirmation page.
 * @param {Event} event - The event object from a form submission.
 */
function sendMail(event) {
    event.preventDefault();
    const data = new FormData(event.target);

    fetch("https://formspree.io/f/mnqkwrjn", {
        method: "POST",
        body: data,
        headers: {
